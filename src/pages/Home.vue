  ...
  >
    ...
    <div class="container hero-content">
      ...
      <h1>
        ...
        <em>A quote made simple.</em>
      </h1>

      <p class="hero-copy">
        Browse our range of fibreglass pools, choose your favourite and
        request a quote. Simple, straightforward and without the
        unnecessary steps.
      </p>
